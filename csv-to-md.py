# Modified cloned copy by Christopher Goodwin on 2024.04.08
# Changed template and changed exported file names; added stars instead of numbers for ratings

# Original Author: Jason Burns
...
""" 
 ...
 Output each row as a new file using the desired structure
  Substitute the data in the template with the book data
...
def write_book_md(title, author, yearpublished, book_md):
    ...
    book_file_name = author + " - " + title + " - " + yearpublished + ".md"
...
def main():
    ...
    with open(csv_path, newline="", encoding="UTF-8") as csv_file:
        ...
        for count, row in enumerate(reader):
            ...
            rating = int(date_dict["MyRating"])
            date_dict["MyRating"] = rating * '☆'
            ...
            author = date_dict["Authorl-f"]

            published = date_dict["YearPublished"]

            write_book_md(title, author, published, book_md)
